              ...
              <div key={index}>
                <article class="flex max-w-xl flex-col items-start justify-between">
                  <h3 class="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
                    <a href="#">{testimonials?.experiences[0]?.job?.title}</a>
                  </h3>
                  <div class="flex items-center gap-x-4 text-xs mt-2">
                    ...
                    >
                      {testimonials?.experiences[0]?.difficultyLevel}
                    </a>

                    <p>
                      Experience for{" "}
                      {testimonials?.experiences[0]?.company.name}
                    </p>
                  </div>
                  <div class="group relative">
                    <p class="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">
                      {testimonials?.experiences[0]?.description}
                    </p>
                  </div>
                  <div class="relative mt-8 flex items-center gap-x-4">
                    <div class="h-10 w-10 flex-shrink-0">
                      <Avatar>
                        <AvatarFallback>
                          {testimonials?.name[0]?.toUpperCase()}
                        </AvatarFallback>
                      </Avatar>
                    </div>
                    <div class="text-sm leading-6">
                      ...
                      <p class="text-gray-600">
                        Current working at {testimonials?.currentCompany}
                      </p>
                    </div>
                  </div>
                </article>
