      ...
      <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <div>
          ...
          <div>
            ...
            <input type="text" id="subject" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Let us know how we can help you" required onClick={(e) => {
              e.preventDefault();
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium shadow-xl text-center text-white rounded-lg bg-slate-800  sm:w-fit hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
        </form>
      </div>
    </section>
  )
